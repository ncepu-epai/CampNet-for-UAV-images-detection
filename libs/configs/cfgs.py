...
#5472*3648
# IMG_SHORT_SIDE_LEN =1728 #500 #1800 # 1600 #1024 #2000 #600  # 600  # 600
# IMG_MAX_LENGTH =1728 #375 #1800 #2000 #1000  # 1000  # 1000
IMG_SHORT_SIDE_LEN =2000
IMG_MAX_LENGTH =2800
CLASS_NUM =2
...
#BASE_ANCHOR_SIZE_LIST = [8, 16, 32, 64, 128]  #[32, 64, 128, 256, 512]
ANCHOR_STRIDE_LIST = [4, 8, 16, 32, 64]
#ANCHOR_STRIDE_LIST = [1, 2, 4, 8, 16]
ANCHOR_SCALES = [1.0]
...
SHARE_HEADS = True
KERNEL_SIZE = 3
RPN_IOU_POSITIVE_THRESHOLD = 0.7  #从anchor中，与gt_box交并比大于该值的作为正例子
RPN_IOU_NEGATIVE_THRESHOLD = 0.3  #从anchor中，与gt_box交并比小于该值的作为负例子
TRAIN_RPN_CLOOBER_POSITIVES = False

RPN_MINIBATCH_SIZE = 256   #
RPN_POSITIVE_RATE = 0.5
RPN_NMS_IOU_THRESHOLD = 0.7    #RPN网络输出的RoI中，选取该值作为softmax的阈值
...
FAST_RCNN_MINIBATCH_SIZE = 256  # if is -1, that is train with OHEM #一张图中有256个RoI，送入分类网络
FAST_RCNN_POSITIVE_RATE = 0.25 #一张图中有256*0.25=64个正RoI，送入分类网络

ADD_GTBOXES_TO_TRAIN = False  #是否将gt_box也加入到RoI中，用于分类层的训练
