...
import os
image_raw_data = tf.gfile.FastGFile('demos/000129.jpg', 'rb').read()
...
with tf.Session() as sess:
    ...
    #
    # # 将图片的亮度-0.5。
    # adjusted = tf.image.adjust_brightness(img_data, 0.2)
    ...
    # plt.show()
    # # 将图片的对比度+5
    adjusted = tf.image.adjust_contrast(img_data, 0.6)
    plt.imshow(adjusted.eval())
    plt.show()
